// 파일 경로: src/app/main/filters/avatars/BlackDentalMaskFilter.ts
...
export class BlackDentalMaskFilter implements FaceFilter {
  readonly id = "black-dental-mask"
  readonly name = "검정 마스크"
  readonly emoji = "😷"
  ...
  render(
    ...
    bodyGradient.addColorStop(0, "#16181d")
    bodyGradient.addColorStop(0.42, "#0d1117")
    bodyGradient.addColorStop(0.78, "#05070b")
    ...
    highlightGradient.addColorStop(0.45, "rgba(255,255,255,0.05)")
    ...
    ctx.fillStyle = "rgba(107, 114, 128, 0.52)"
    drawPerforationRow(
      ctx,
      -topWidth * 0.42,
      topWidth * 0.42,
...
filterRegistry.register(new BlackDentalMaskFilter())
